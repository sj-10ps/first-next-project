...
const MobileDropdown = ({session,provider}) => {
    ...
    <div className=' bg-blue-700 p-2 flex flex-col gap-2 '>
       ...
       {!session&&
        provider&&Object.values(provider).map((p,index)=>(
            <button className="flex bg-gray-600 hover:bg-gray-800 px-3 py-2 gap-2 items-center rounded-lg" key={index} onClick={()=>signIn(p.id)}>
